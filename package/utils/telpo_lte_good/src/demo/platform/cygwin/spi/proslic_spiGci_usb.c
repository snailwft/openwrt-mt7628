/*
** $Id: proslic_spiGci_usb.c 4638 2014-12-18 20:14:44Z nizajerk $
**
** spi.h
...
int gl_eeprom_read = 0;
unsigned short eeprom_buffer[512];  /* 2x size to be safe */

/*
**  Wrap VMB eeprom functionality to behave like VMB2
**
**
**
**/
unsigned char ReadEEPROMByte(unsigned short addr)
{
    ...
    if(gl_eeprom_read == 0)
    {
        readEEPROMContents(eeprom_buffer);
    }

    return (unsigned char)(eeprom_buffer[addr]&0x00FF);
}

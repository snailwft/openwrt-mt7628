...
** 2015-05-06 10:32:09
**
** Si3218x ProSLIC API Configuration Tool Version 4.0.1
** Last Updated in API Release: 8.0.0rc2
...
0x061DCB70L,	/* VBATR_EXPECT (95.569 v) */
...
0x80,			/* RINGCON */
0x00,			/* USERSTAT */
0x030EE5B8L,	/* VCM_RING (44.784 v) */
0x030EE5B8L,	/* VCM_RING_FIXED */

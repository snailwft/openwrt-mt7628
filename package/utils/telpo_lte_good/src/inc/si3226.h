...
**
** $Id: si3226.h 4727 2015-02-10 22:35:54Z nizajerk $
**
** Author(s): 
** laj
**
...
/*
** SI3226 Data Types/Function Definitions 
*/

#define NUMIRQ 4
#define SI322X_CHAN_PER_DEVICE             2
...
/*
** Defines structure for configuring synthesized impedance
*/
typedef struct {

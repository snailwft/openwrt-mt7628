/*
** Copyright (c) 2011-2015 by Silicon Laboratories
**
** $Id: proslic_tstin.c 4825 2015-03-25 16:38:48Z elgeorge $
**
** Author(s): 
** cdp
**
...
#define TSTIN_VALID_SI3218X_PART_NUM (pProslic->deviceId->chipType >= SI32180 && pProslic->deviceId->chipType <= SI32181)
...
#define TSTIN_INVALID_PART_NUM  !(TSTIN_VALID_SI3217X_PART_NUM || TSTIN_VALID_SI3218X_PART_NUM || TSTIN_VALID_SI3226X_PART_NUM || TSTIN_VALID_SI3228X_PART_NUM)
...
int ProSLIC_createTestInObj(proslicTestInObjType_ptr *pTstin)
{
	...
	*pTstin = SIVOICE_CALLOC(sizeof(proslicTestInObjType),1);
	return RC_NONE;
#else

...
**
** $Id: si3226x_intf.c 4969 2015-04-28 00:26:38Z nizajerk $
**
** SI3226X_Intf.c
...
#define SI3226X_IRING_LIM_MAX 0x8B9ACAL
/*
** Externs
*/
    ...
    */
    ...
    if((init_opt == INIT_REINIT) || (init_opt == INIT_SOFTRESET))
    {
        ...
        for(k = 0; k < j; k++)
        {
	        ...
	        Si3226x_PowerDownConverter(pProslic[k]);
        }
    ...
    */
    ...
    { 
        if ((pProslic[k]->channelEnable)&&(pProslic[k]->channelType == PROSLIC)){
         ...
         pProslic[k]->WriteRAMX(pProslic[k]->pProHWX,pProslic[k]->channel,IRING_LIM,SI3226X_IRING_LIM_MAX);
    }

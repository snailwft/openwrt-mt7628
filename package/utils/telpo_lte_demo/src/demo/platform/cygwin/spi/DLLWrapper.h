/*
** $Id: DLLWrapper.h 4638 2014-12-18 20:14:44Z nizajerk $
**
** DLLWrapper.h
...
** none
*/
void Write2RegExp (unsigned char addr0, unsigned char data0,unsigned char addr1, unsigned char data1);
void Write2RegDelayExp (unsigned char addr0, unsigned char data0,unsigned char addr1, unsigned char data1,unsigned short delay);
/*
** Function: setChannel
**
** Description: 

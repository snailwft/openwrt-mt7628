...
0x072B01D5L,    /* VBATR_EXPECT (112.00) */
...
int si3228x_genconf_multi_max_preset = SI3228X_GEN_PARAM_LAST;

Si3228x_General_Cfg Si3228x_General_Configuration_MultiBOM[SI3228X_GEN_PARAM_LAST] = {
{ /*  SI3228X_LCQC5W */ 
0x78,     /* DEVICE_KEY */
BO_DCDC_LCQC_5W,    /* BOM_OPT */
BO_DCDC_TRACKING,    /* BAT_RAIL_TYPE */
...
BO_DCDC_TRACKING,    /* BAT_RAIL_TYPE */
0x000AD000L,    /* bat_hyst */
0x06666635L,    /* VBATR_EXPECT (112.00) */
0x03D70A20L,    /* VBATH_EXPECT (60.00) */
0x0FFF0000L,    /* PWRSAVE_TIMER */
0x01999A00L,    /* OFFHOOK_THRESH */
0x00F00000L,    /* VBAT_TRACK_MIN */
...
0x00000000L,	/* EFPI_RING_PERIOD */
0x00000000L,	/* EFPI_RING_PHASE */

...
**
** $Id: si3217x_revb_intf.c 4557 2014-10-29 20:45:21Z nizajerk $
**
 ...
 ramData ram_data;
    ...
    case INIT_SEQ_PRE_CAL:
        ...
        */
        ...
        WriteRAM(pProHW,pProslic->channel,SI3217X_COM_RAM_VCMLPF,0x10059FL);        /* 20pps pulse dialing */
        WriteRAM(pProHW,pProslic->channel,SI3217X_COM_RAM_CM_SPEEDUP_TIMER,0xF0000L); /* 20pps pulse dialing */
		WriteRAM(pProHW,pProslic->channel,SI3217X_COM_RAM_VCM_TH,0x106240L);        /* 20pps pulse dialing */
